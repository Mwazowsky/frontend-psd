...
function TrialSection() {
    ...
    function getData(){
        ...
        fetch('https://flask-production-cbe1.up.railway.app/crop', requestOptions)
    ...
    return (
        <div className="section trailSection">
            <div className="trailSectionLeft">
                ...
                <h3>
                    Masukkan informasi lahan Anda dan dapatkan rekomendasi tanaman
                </h3>
            </div>
            <div className="trailSectionRight">
                <form action="http://localhost:5000/crop" method="POST">
                    ...
                    <div className="inputRow">
                        <div className="inputDiv">
                            <label htmlFor="potassium">Nilai Potassium</label>
                    ...
                    <div className="inputRow">
                        <div className="inputDiv">
                            <label htmlFor="state">Bulan Tanam</label>
                            <select
                        ...
                        <div className="inputDiv">
                            <label htmlFor="district">Bulan Panen</label>
                            <select
                    ...
                    <div className="inputRow">
                        <div className="inputDiv">
                            <label htmlFor="state">Kabupaten</label>
                            <select
